...
static const char _HTTP_HEAD[] PROGMEM   = {
...
static const char _HTTP_STYLE[] PROGMEM  = {
"<style type='text/css'>"
...
static const char _HTTP_HEAD_END[] PROGMEM = {
" <body> "
"  <div class='container'> "
"   <div id='contact'> "
...
static const char _HTTP_AP_LIST[] PROGMEM = {
" <h4 >请选择需要连接的热点:</h4> "
...
static const char _HTTP_AP_LIST_ITEM[] PROGMEM = {
" <option value='{n}'>  {n}</option>"
};

static const char _HTTP_FORM[] PROGMEM = {
...
"     </fieldset> "
"     <fieldset> "
"      <input id='server_name' placeholder='服务器地址' type='text' name='server_name' tabindex='3' required='' /> "
"     </fieldset> "
"     <fieldset> "
"      <input id='topic_prefix' placeholder='主题前缀' type='text' name='topic_prefix' tabindex='4' required='' /> "
"     </fieldset> "
"     <fieldset> "
};

static const char _HTTP_SERVER_LIST[] PROGMEM = {
...
static const char _HTTP_FORM_END[] PROGMEM = {
"     </fieldset> "
"     <fieldset> "
...
static const char _HTTP_END[] PROGMEM = {
"  </div> "
" </body>"
"</html>"
};
